...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"work-5.jpg":[function(require,module,exports) {
module.exports = "/work-5.8c199d22.jpg";
...
var _work = _interopRequireDefault(require("./work-5.jpg"));

var _blocks = require("./classes/blocks");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var model = [new _blocks.TitleBlock('constructor', {
  tag: 'h2',
  styles: {
    color: 'red',
    padding: '1rem'
  }
}), new _blocks.ImageBlock(_work.default, {
  styles: {
    padding: '2rem 0',
    display: 'flex',
...
// 	}
// },
new _blocks.ColumnsBlock(['lorem jldsjfslkdj ld lkjfsdl kjflsdkj f', 'lorem', 'lorem tree'], {
  styles: {
    background: '#fff',
    padding: '2rem',
    color: '#000',
...
}), new _blocks.TextBlock('sometext', {
  styles: {
    background: '#fff',
    padding: '1rem',
    'font-weight': 'bold'
...
exports.model = model;
},{"./work-5.jpg":"work-5.jpg","./classes/blocks":"classes/blocks.js"}],"classes/site.js":[function(require,module,exports) {
"use strict";
...
new _sidebar.Sidebar('#panel', updateCallBack); // model.forEach(block => {
// 	// let html = ''
// 	// if (block.type == 'title') {
// 	// 	html = title(block)
...
// })
},{"./model":"model.js","./classes/site":"classes/site.js","./classes/sidebar":"classes/sidebar.js","./styles/style.css":"styles/style.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
